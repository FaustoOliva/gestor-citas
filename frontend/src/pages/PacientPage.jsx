        ...
        <Container className="text-center mt-5">
            ...
            {activeView === 'appointments' && (
                <>
                    ...
                    <Appointments userId={currentUser ? currentUser.User_Id : null} refreshTrigger={refreshAppointments} />
                </>
            )}

            {activeView === 'pets' && (
                <>
                    <CreatePetForm userId={currentUser ? currentUser.User_Id : null} onPetCreated={handlePetCreated} />
                    <Pets userId={currentUser ? currentUser.User_Id : null} refreshTrigger={refreshPets} />
                </>
            )}
        </Container>
    );
